...
- Obtener todos los productos: `node index.js GET products`

- Obtener un producto por ID: `node index.js GET products/5`

- Crear un producto: `node index.js POST products "Camisa nueva" 29.99 "clothing"`

- Eliminar un producto: `node index.js DELETE products/5`
